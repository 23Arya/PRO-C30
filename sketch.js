...
if(block9.isTouching(ground)){
  block9.visible = false;
}
if(block10.isTouching(ground)){
  block10.visible = false;
}
if(block11.isTouching(ground)){
  block11.visible = false;
}
if(block12.isTouching(ground)){
  block12.visible = false;
}
if(block13.isTouching(ground)){
  block13.visible = false;
}
if(block14.isTouching(ground)){
  block14.visible = false;
}
if(block15.isTouching(ground)){
  block15.visible = false;
}
if(block16.isTouching(ground)){
